...
sht25_ns = cg.esphome_ns.namespace('sht25')
SHT25Component = sht25_ns.class_('SHT25Component', cg.PollingComponent, i2c.I2CDevice)

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(SHT25Component),
